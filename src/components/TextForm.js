...
<button className='btn btn-primary mx-3'onClick={handleReClick}>Remove extra spaces</button>
<button className='btn btn-primary mx-3'onClick={handleClClick}>Clear Text</button>
<button className='btn btn-primary mx-3'onClick={handleCpClick}>Copy Text</button>
    </div>
    <div className='container'style={{color:props.mode==='dark'?'white':'#042743'}}>
